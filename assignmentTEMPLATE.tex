...
\setlength{\droptitle}{-10em} % set the title to the top of the page
\title{ \textbf{Problem Sheet XXX}}


\setcounter{section}{0} % set assignment number XXX
\begin{document}	 
 \maketitle	 
 ...
 % Solution 
%add more subsections for more assignment questions..
\end{document}
